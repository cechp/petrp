<?php
// source: /home/petrp/Projekty/Nette/config/common.neon
// source: /home/petrp/Projekty/Nette/config/services.neon
// source: array
...
class Container_95483c66d5 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Presentation\Edit\EditPresenter' => [2 => ['application.6']],
	...
	public function createServiceApplication__6(): App\Presentation\Edit\EditPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/petrp/Projekty/Nette/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/home/petrp/Projekty/Nette/temp/cache');
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_95483c66d5 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/petrp/Projekty/Nette/temp/cache/latte');
